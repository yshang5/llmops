      ...
      <div class="bg-white h-full rounded-lg px-2 py-4 flex flex-col justify-between">
        ...
        <div class="">
          ...
          <div class="flex flex-col gap-2">
            <router-link
              to="/home"
              class="flex items-center gap-2 h-8 leading-8 rounded-lg transition-all px-2 text-gray-700 hover:bg-gray-200"
            ...
            <router-link
              to="/space/apps"
              :class="`flex items-center gap-2 h-8 leading-8 rounded-lg transition-all px-2 text-gray-700 hover:bg-gray-200 ${route.path.startsWith('/space') ? 'bg-gray-100' : ''}`"
              active-class="bg-gray-100"
            >
        ...
        <a-dropdown position="tl">
          <div
            class="flex items-center g-2 gap-2 transition-all cursor-pointer rounded-lg hover:bg-gray-100"
          >
            <a-avatar :size="32" class="text-sm bg-blue-700"> 尚 </a-avatar>
            <div class="flex flex-col">
              <div class="text-sm text-gray-900">尚越</div>
              <div class="text-sm text-gray-500">xxx@gmail.com</div>
            </div>
          </div>
          <template #content>
            <a-doption>
